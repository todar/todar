...
<p align="center">Software developer with over 9 years of experience within a corporate environment. Highly skilled with Python and advanced VBA within Microsoft Excel — have created a full scale applications that saves over 46,000 labor hours a year. Created over 70 business critical SQL queries within DB2 and Oracle. Very knowledgeable with web development as well, especially with functional JavaScript and NodeJS — experienced with React and Svelte frameworks. Located in Phoenix, AZ.</p>
